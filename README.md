...
|      |                                                              |       |      | memo                                                         |
| ---- | ------------------------------------------------------------ | ----- | ---- | ------------------------------------------------------------ |
| 1    | [两数之和](https://leetcode-cn.com/problems/two-sum)         | 50.6% | 简单 |                                                              |
| 2    | [两数相加](https://leetcode-cn.com/problems/add-two-numbers) | 39.8% | 中等 |                                                              |
| 3    | [无重复字符的最长子串](https://leetcode-cn.com/problems/longest-substring-without-repeating-characters) | 36.7% | 中等 |                                                              |
| 4    | [寻找两个正序数组的中位数](https://leetcode-cn.com/problems/median-of-two-sorted-arrays) | 39.8% | 困难 |                                                              |
| 5    | [最长回文子串](https://leetcode-cn.com/problems/longest-palindromic-substring) | 33.5% | 中等 |                                                              |
| 6    | [Z 字形变换](https://leetcode-cn.com/problems/zigzag-conversion) | 49.7% | 中等 |                                                              |
| 7    | [整数反转](https://leetcode-cn.com/problems/reverse-integer) | 35.0% | 简单 |                                                              |
| 8    | [字符串转换整数 (atoi)](https://leetcode-cn.com/problems/string-to-integer-atoi) | 21.3% | 中等 |                                                              |
| 9    | [回文数](https://leetcode-cn.com/problems/palindrome-number) | 58.7% | 简单 |                                                              |
| 10   | [正则表达式匹配](https://leetcode-cn.com/problems/regular-expression-matching) | 31.0% | 困难 |                                                              |
| 11   | [盛最多水的容器](https://leetcode-cn.com/problems/container-with-most-water) | 64.6% | 中等 |                                                              |
| 12   | [整数转罗马数字](https://leetcode-cn.com/problems/integer-to-roman) | 64.9% | 中等 |                                                              |
| 13   | [罗马数字转整数](https://leetcode-cn.com/problems/roman-to-integer) | 62.4% | 简单 |                                                              |
| 14   | [最长公共前缀](https://leetcode-cn.com/problems/longest-common-prefix) | 39.3% | 简单 |                                                              |
| 15   | [三数之和](https://leetcode-cn.com/problems/3sum)            | 31.4% | 中等 | 排序+遍历（遍历A，左右双指针BC），ABC相加得零                |
...
| 23   | [合并K个升序链表](https://leetcode-cn.com/problems/merge-k-sorted-lists) | 54.6% | 困难 |                                                              |
| 24   | [两两交换链表中的节点](https://leetcode-cn.com/problems/swap-nodes-in-pairs) | 69.3% | 中等 | 步进2用dummyheader去交换后两个，注意循环最后边界条件的处理   |
| 25   | [K 个一组翻转链表](https://leetcode-cn.com/problems/reverse-nodes-in-k-group) | 64.4% | 困难 |                                                              |
| 26   | [删除有序数组中的重复项](https://leetcode-cn.com/problems/remove-duplicates-from-sorted-array) | 53.0% | 简单 |                                                              |
| 27   | [移除元素](https://leetcode-cn.com/problems/remove-element)  | 59.1% | 简单 |                                                              |
| 28   | [实现 strStr()](https://leetcode-cn.com/problems/implement-strstr) | 39.7% | 简单 |                                                              |
| 29   | [两数相除](https://leetcode-cn.com/problems/divide-two-integers) | 20.4% | 中等 |                                                              |
| 30   | [串联所有单词的子串](https://leetcode-cn.com/problems/substring-with-concatenation-of-all-words) | 34.2% | 困难 |                                                              |
...
| 110  | [平衡二叉树](https://leetcode-cn.com/problems/balanced-binary-tree) | 55.4% | 简单 |                                                              |
...
| 147  | [对链表进行插入排序](https://leetcode-cn.com/problems/insertion-sort-list) | 67.3% | 中等 |                                                              |
...
| 184  | [部门工资最高的员工](https://leetcode-cn.com/problems/department-highest-salary) | 46.8% | 中等 |                                                              |
...
| 221  | [最大正方形](https://leetcode-cn.com/problems/maximal-square) | 44.8% | 中等 |                                                              |
